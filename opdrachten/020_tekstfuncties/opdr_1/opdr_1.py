...
stukjetekst = "O mamma mia, wat maak je toch heerlijke pizza's"
...
tekststukje = "zei ooit: 'Als je niks fout doet, dan kun je ook niks leren!'"

print(f"{voornaam} {achternaam} {tekststukje}")